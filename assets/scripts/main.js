  ...
  if ('serviceWorker' in navigator) {
    ...
    window.addEventListener('load', () => {
      ...
      .catch(e => {
        ...
        console.log('Service Worker did not work ', e);
      });
    });
  }
...
async function getRecipes() {
  ...
  //            will be in the catch portion.
      try{
        ...
        //            resolve() method.
        if (recipe_arry.length === RECIPE_URLS.length) {
          saveRecipesToStorage(recipe_arry);
          resolve(recipe_arry);
        }
      }
      catch(e){
        // A10. TODO - Log any errors from catch using console.error
        console.error('Error while fetching recipe:', e);
